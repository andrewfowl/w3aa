export const past_events=[{
    ...
    time: '1:00 PM PST',
    location: 'Virtual',
    description: 'Hello everyone. On November 5, 2024, I held the first meeting of the Web3 Accounting Alliance (W3AA). 
    W3AA hosts virtual meetings of crypto accounting professionals. These small-group events facilitate discussions of issues and 
    challenges that are at the top of crypto finance teams' minds and the agenda is shaped and driven by the participants.
    ...
    an individual opinion of a staff who was helping to answer the question.
        ...
        About Ripple
        Using proven crypto and blockchain technology honed over a decade, Ripple’s enterprise-grade solutions are faster, more transparent, and 
    more cost-effective than traditional financial services. Our customers use these solutions to source crypto, facilitate instant payments, empower 
